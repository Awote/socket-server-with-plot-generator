...
class wait_fixed(wait_base):
    ...
    def __init__(self, wait: _utils.time_UnitType) -> None:
...
class wait_random(wait_base):
    ...
    def __init__(self, min: _utils.time_UnitType = 0, max: _utils.time_UnitType = 1) -> None:  # noqa
...
class wait_incrementing(wait_base):
    ...
    def __init__(
        self,
        start: _utils.time_UnitType = 0,
        increment: _utils.time_UnitType = 100,
        max: _utils.time_UnitType = _utils.MAX_WAIT,  # noqa
    ) -> None:
...
class wait_exponential(wait_base):
    ...
    def __init__(
        ...
        min: _utils.time_UnitType = 0,  # noqa
    ) -> None:
